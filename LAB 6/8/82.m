...
for runs=1:nruns,
	...
	message_freq = ts*fft(message,Nfft); %FFT of size Nfft, automatically zeropads as needed 
	message_freq_centered = fftshift(message_freq); %shifts DC to center of spectrum 
