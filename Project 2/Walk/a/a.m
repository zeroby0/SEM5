...
plot(time_accel, signal_accel_x);

hold;

plot(time_accel, signal_accel_y);
plot(time_accel, signal_accel_z);

print -dpng 3ax.png

figure 2;

plot(time_accel, signal_orientation_x);

hold;

plot(time_accel, signal_orientation_y);
plot(time_accel, signal_orientation_z);
...
[time_mag_accel, _, _, _, mag_accel] = getAngles(time_accel, signal_accel_x, signal_accel_y, signal_accel_z);

% plot(time_mag_accel, mag_accel);

[freq_mag_accel, mag_mag_accel] = getFFT(mag_accel, Fs);

plot(freq_mag_accel, mag_mag_accel);
